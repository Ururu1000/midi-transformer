"""LLaMA-style decoder-only transformer for symbolic music tokens.

RoPE + RMSNorm + SwiGLU + tied embeddings, SDPA attention with optional
KV-cache decoding and block-diagonal packed-training masks.
"""
...
class MusicTransformer(nn.Module):
    ...
    @classmethod
    def from_config(cls, config: ModelConfig) -> MusicTransformer:
        return cls(
